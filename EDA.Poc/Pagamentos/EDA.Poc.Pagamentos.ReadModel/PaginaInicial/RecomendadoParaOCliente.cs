...
{
    public class RecomendadoParaOCliente
    {
        ...
        public virtual List<RecomendadoParaOClienteCompetencia> CompetenciasAvaliadas { get; set; }

        public RecomendadoParaOCliente()
        {
            CompetenciasAvaliadas = new List<RecomendadoParaOClienteCompetencia>();
        }

...
{
    public sealed class ResponsaveisPorResultados : ConteudoBase
    {
        ...
        public ResponsaveisPorResultados()
        {
            IdDoConteudo = Guid.Parse("817eba27-47a7-4eea-b3e8-15c752e88ee5");
            Titulo = "Responsáveis Por Resultados";
                           ...
                           new Preview
                               {
                                   ...
                                   IdDoPreview = Guid.Parse("a84e0218-553c-494f-81da-931463de8f82"),
                           ...
                           new Preview
                               {
                                   IdDoConteudo = IdDoConteudo,
                                   SiglaDoIdioma = Constantes.SiglaDoIdioma,
                                   IdDoPreview = Guid.Parse("31518107-5329-4088-9246-1dba878888a9"),
                                   Titulo = "Cliente Carente",
                               }
                       };
        }

...
{
    public sealed class SolucaoEProblema : ConteudoBase
    {
        ...
        public SolucaoEProblema()
        {
            IdDoConteudo = Guid.Parse("4101d843-2c9b-4ceb-afde-cd9fe87879fb");
            Titulo = "Solução e Problema";
                           ...
                           new Preview
                               {
                                   ...
                                   IdDoPreview = Guid.Parse("6dc27874-0f26-4639-9ffc-4d443a45281f"),
                           ...
                           new Preview
                               {
                                   IdDoConteudo = IdDoConteudo,
                                   SiglaDoIdioma = Constantes.SiglaDoIdioma,
                                   IdDoPreview = Guid.Parse("c872ba37-efd9-4767-bda1-75a5c2b04a3f"),
                                   Titulo = "Cliente Carente",
                               }
                       };
        }

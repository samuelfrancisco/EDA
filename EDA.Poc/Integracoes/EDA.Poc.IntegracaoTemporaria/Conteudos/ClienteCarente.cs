...
{
    public sealed class ClienteCarente : ConteudoBase
    {
        ...
        public ClienteCarente()
        {
            IdDoConteudo = Guid.Parse("565f9b5d-f7f1-477a-b787-b666bdbf2751");
                           ...
                           new Preview
                               {
                                   ...
                                   IdDoPreview = Guid.Parse("2bfe7866-1399-447f-b504-2b27471dc46a"),
                                   Titulo = "Cliente Carente",
                               },
                           new Preview
                               {
                                   IdDoConteudo = IdDoConteudo,
                                   SiglaDoIdioma = Constantes.SiglaDoIdioma,
                                   IdDoPreview = Guid.Parse("853bbeda-1a4a-44c9-aeb0-27befbbf85e0"),
                                   Titulo = "Cliente Carente",
                               }
                       };
        }

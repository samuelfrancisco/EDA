...
{
    public sealed class VendemosSolucoes : ConteudoBase
    {
        ...
        public VendemosSolucoes()
        {
            IdDoConteudo = Guid.Parse("1fab9893-7107-40ff-a480-984c34a39dd0");
            Titulo = "Vendemos Solucoes";
                           ...
                           new Preview
                               {
                                   ...
                                   IdDoPreview = Guid.Parse("ad1ba9fa-f001-4489-8c73-ddfad2fb3a71"),
                           ...
                           new Preview
                               {
                                   IdDoConteudo = IdDoConteudo,
                                   SiglaDoIdioma = Constantes.SiglaDoIdioma,
                                   IdDoPreview = Guid.Parse("48168dd2-8902-4fdc-9281-457b6581217a"),
                                   Titulo = "Cliente Carente",
                               }
                       };
        }
